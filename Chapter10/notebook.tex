...
\makeatother
    ...
    \section{10.2 Calculus wuth Parametic
Curves}\label{calculus-wuth-parametic-curves}

\subsection{Tangents}\label{tangents}
...
\tightlist
\item
  Show that has two tangents at the point (3, 0) and find their
  equations.
\item
...
\textbf{SOLUTION IN CLASS}

    \subsection{Example 2}\label{example-2}

Conisder the cycloid
\(x=r(\theta-\sin\theta), \quad y=r(1-\cos\theta)\). 1. Find the tangent
at the point where \(\theta=\frac{\theta}{3}\). 2. At what points is the
tangent horizontal? When is it vertical?
